cordova.define("cordova-plugin-purchase.InAppPurchaseProxy", function(require, exports, module) { var cordova = require('cordova');
...
module.exports = {
    init: function (win, fail, args) {
        ...
        if (!this.currentApp){
            this.currentApp = app.currentApp;
            ...
            xhttp.open("GET", "https://" + window.location.host +"/api/store.php?init=" + this.currentApp, true);
            xhttp.send();
            this.productLicenses = this.currentApp.licenseInformation.productLicenses;
        }
    },
