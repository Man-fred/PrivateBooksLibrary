...
templates['about'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<html>\r\n<body>\r\n    <h2>Version</h2>\r\n    <h3>"
    ...
    + "</h3>\r\n    <p>Passwort-Änderung für die Cloud-Datenbank ist jetzt möglich.</p>\r\n    <h2>"
...
templates['password'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;
